...
class PlayState extends MusicBeatState
{
	...
	public static var ratingStuff:Array<Dynamic> = [
		['DUMBASS!', 0.2], //From 0% to 19%
		['PORNED!!!', 0.4], //From 20% to 39%
		['WHAT????', 0.5], //From 40% to 49%
		['STOP LOSING', 0.6], //From 50% to 59%
		['Uh', 0.69], //From 60% to 68%
		['Cool', 0.7], //69%
		['Great', 0.8], //From 70% to 79%
		['Great Bud', 0.9], //From 80% to 89%
		['Fantastic!', 1], //From 90% to 99%
		['WOMBO COMBO!!', 1] //The value on this one isn't used actually, since Perfect is always "1"
	];
	...
	override public function create()
	{
		...
		botplayTxt = new FlxText(400, healthBar.y - 90, FlxG.width - 800, Language.getPhrase("YOU FUCKIN CHEATER").toUpperCase(), 32);
